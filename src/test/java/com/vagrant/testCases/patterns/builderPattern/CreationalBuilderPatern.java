...
public class CreationalBuilderPatern {
	...
	public static void main(String args[]) {
		...
		Phone samsungPhone = new PhoneBuilder().setRam(2).setCompany("Samsung").setBattery(1500).setOs("Android").getPhone();
		...
		Phone applePhone = new PhoneBuilder().setRam(16).setCompany("Apple").setBattery(15000).setOs("MAC").setProcessor("QualComm").getPhone();
